    ...
    return (
        <div className="py-5 max-w-[1440px] xl:px-0 px-5">
            <div className="xl:w-[100%] w-[90%]">
                <p className="sm:text-[64px] text-[40px] w-full flex text-[#1C1139]  lg:pl-0 md:pl-20">Pool Data</p>
                <div>
                ...
                <div className='w-[100%] overflow-x-hidden lg:flex flex-col hidden mt-7'>
                    ...
                    <div className='lg:w-[95%] w-[750px] overflow-x-auto rounded-lg border border-black bg-white'>
                ...
                <div className="max-w-[1250px] mt-12 lg:pl-0 md:pl-20 lg:pr-0 pr-5">
                ...
                <div className=" w-[100%] mt-8 sm:px-12">
                    <div className="flex sm:flex-row flex-col items-center justify-between">
                        ...
                        <button className="w-[224px] h-[44px] border border-[#9F00FF] flex items-center justify-center rounded-lg sm:mt-0 mt-5">
